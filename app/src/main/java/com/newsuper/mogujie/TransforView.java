...
public class TransforView extends View {
    ...
    // 第2页，view元素
    // /////////////////////////////////////////////////////////////////////////
    private int[] mPage2ModelResources = new int[] {R.mipmap.two_1, R.mipmap.two_2, R.mipmap.two_3};
    ...
    // 第3页，view元素
    // /////////////////////////////////////////////////////////////////////////
    private int[] mPage3ModelResources = new int[] {R.mipmap.three_1, R.mipmap.three_2, R.mipmap.three_3,
        R.mipmap.three_4, R.mipmap.three_5, R.mipmap.three_6};
    ...
    // 第4页，view元素
    // /////////////////////////////////////////////////////////////////////////
    private int[] mPage4ModelResources = new int[] {R.mipmap.four_bottom_1, R.mipmap.four_bottom_2,
        R.mipmap.four_bottom_3};
    ...
    private void init() {
        ...
        {
            /** 第1页，顶部模特图 */
            mPage1Top = new ViewModel(getContext(), R.mipmap.one_top).alpha(255)
            ...
            /** 第1页，底部文案图 */
            mPage1Bottom = new ViewModel(getContext(), R.mipmap.one_bottom).alpha(255)
            // 宽度为矩形背景宽度，减去左，右，各5dp边距
                .width(mPage1RectBgDefaultWidth - padding() * 2)
            ...
            /** 第1页，底部背景图 */
            mPage1BottomBg =
                new ViewModel(getContext(), R.mipmap.one_bottom_bg).alpha(255)
                    .width(mPage1RectBgDefaultWidth - padding() * 2)
                    // .height()// 不传则按宽度比例缩放
                    .left(mPage1RectBgDefaultLeft + padding())
...

        {
            ...
            /** 第2页，顶部文案图 */
            mPage2Top = new ViewModel(getContext(), R.mipmap.two_top).width(mPage2RectBgDefaultWidth - padding() * 2)
            // .height()// 不传则按宽度比例缩放
            ...
            /** 第2页，底部文案图 */
            mPage2Bottom =
                new ViewModel(getContext(), R.mipmap.two_bottom).width(mPage2RectBgDefaultWidth - padding() * 2)
                    .height(
            ...
            for (int i = 0; i < 2; i++) {
                mPage2Split[i] =
                    new ViewModel(getContext(), R.mipmap.two_bg).width(mPage2RectBgDefaultWidth)
...

        {
            /** 第4页，顶部模特图 */
            mPage4Top =
                new ViewModel(getContext(), R.mipmap.four_top).width(mPage4RectBgDefaultWidth - padding() * 2)
            ...
            for (int i = 0; i < mPage4Split.length; i++) {
                mPage4Split[i] = new ViewModel(getContext(), R.mipmap.four_bg)
